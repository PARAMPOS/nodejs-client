import { IslemIzleme } from "./src/index.js";
...
const response = await IslemIzleme({
  Tarih_Bas: "20.11.2024 00:00:00",
  Tarih_Bit: "20.11.2024 15:00:00",
  Islem_Tip: "Satış", // "İptal || İade || Satış" Gönderilmediği taktirde hepsi döner
  Islem_Durum: "Başarılı",
});

console.log("islem_izleme", response);